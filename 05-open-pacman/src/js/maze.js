...
//   'o' power pellet(4) — dot grande parpadeante (SPEC 04)
...
const MAZE_STR = [
  ...
  '#.####.#####.##.#####.####.#', // 21
  '#.####.#####.##.#####.####.#', // 22
  '#o..##................##..o#', // 23  fila inicio Pacman (13,23); power pellets (1,23) y (26,23)
  '###.##.##.########.##.##.###', // 24
  '###.##.##.########.##.##.###', // 25
  '#......##....##....##......#', // 26
  '#.##########.##.##########.#', // 27
...
function parseTile( ch ) {
  ...
  if ( ch === '.' ) return 2;
  if ( ch === '-' ) return 3;
  if ( ch === 'o' ) return 4; // power pellet (SPEC 04)
...
const GHOST_STARTS = [
  { x: 12, y: 14, kind: 'blinky' }, // dentro de la pen
